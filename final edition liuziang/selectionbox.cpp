...
int SelectionBox::GetY() const     //获取纵坐标
{
    return my;
}
int SelectionBox::GetWidth() const //得到宽
{
    return mwidth;
}
int SelectionBox::GetHeight() const //得到高
{
    return mheight;
}
...
void SelectionBox::CheckTower(int x, int y)
{
    ...
    SubBut[0].SubImgPath = QString(":/image/Buytower1.png");
    SubBut[1].SubX = mx + 14, SubBut[1].SubY = my + 106;
    SubBut[1].SubImgPath = QString(":/image/Buytower2.png");
    SubBut[2].SubX = mx + 202, SubBut[2].SubY = my + 106;
    SubBut[2].SubImgPath = QString(":/image/Buytower3.png");
    SubBut[3].SubX = mx + 106, SubBut[3].SubY = my + 190;
    SubBut[3].SubImgPath = QString(":/image/Buytower4.png");
